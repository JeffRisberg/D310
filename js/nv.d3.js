      ...
      selection.each(function (data) {
        ...
        if (showValues && !stacked) {
          ...
          bars.transition()
            .select('text')
            .attr('x', function (d, i) {
              return getY(d, i) < 0 ? -4 : y(getY(d, i)) - y(y.domain()[0]) + 4
            })
        } else {
        ...
        if (showBarLabels && !stacked) {
          ...
          bars.transition()
            ...
            .attr('x', function (d, i) {
              return getY(d, i) < 0 ? y(y.domain()[0]) - y(getY(d, i)) + 4 : -4
            });
        }
        else {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        if (style == 'stack') {
          ...
          var extent0 = d3.extent(dataFiltered[0].values.map(function (d) {
            return d.y;
          })
          );

          var minY = extent0[0]
          if (forceY.length > 0) minY = Math.min(minY, forceY[0]);
        }
        else {
          minY = 0;
          forceY = [0];
